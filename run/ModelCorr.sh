...
outTomlDir=${myDir}/AutoToml_Ratios/02_03_2023/ModelCorr/
...
#Charmless#     find ${outTomlDir} -type f -name ${UN}_${qqq}_${temp}_${RAT}_${PAR}-base.toml -exec sed -i.bak "s~EXT~ModelCorr~g" {} \;
...
#Charmless#    done
	...
	find ${outTomlDir} -type f -name ${UN}_${qqq}_${temp}_${RAT}_${PAR}-base.toml -exec sed -i.bak "s~EXT~ModelCorr~g" {} \;
...
#J32#	find ${outTomlDir} -type f -name ${UN}_${qqq}_${temp}_${RAT}_${PAR}-base.toml -exec sed -i.bak "s~EXT~ModelCorr~g" {} \;
